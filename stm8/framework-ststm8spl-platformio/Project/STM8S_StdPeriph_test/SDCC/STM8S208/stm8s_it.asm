...
;	../stm8s_it.c: 175: }
	iret
;	../stm8s_it.c: 197: INTERRUPT_HANDLER(CAN_RX_IRQHandler, 8)
;	-----------------------------------------
...
;	../stm8s_it.c: 202: }
	iret
;	../stm8s_it.c: 209: INTERRUPT_HANDLER(CAN_TX_IRQHandler, 9)
;	-----------------------------------------
...
;	../stm8s_it.c: 301: }
	iret
;	../stm8s_it.c: 311: INTERRUPT_HANDLER(TIM3_UPD_OVF_BRK_IRQHandler, 15)
;	-----------------------------------------
...
;	../stm8s_it.c: 316: }
	iret
;	../stm8s_it.c: 323: INTERRUPT_HANDLER(TIM3_CAP_COM_IRQHandler, 16)
;	-----------------------------------------
...
;	../stm8s_it.c: 394: }
	iret
;	../stm8s_it.c: 428: INTERRUPT_HANDLER(UART3_TX_IRQHandler, 20)
;	-----------------------------------------
...
;	../stm8s_it.c: 433: }
	iret
;	../stm8s_it.c: 440: INTERRUPT_HANDLER(UART3_RX_IRQHandler, 21)
;	-----------------------------------------
...
;	../stm8s_it.c: 445: }
	iret
;	../stm8s_it.c: 454: INTERRUPT_HANDLER(ADC2_IRQHandler, 22)
;	-----------------------------------------

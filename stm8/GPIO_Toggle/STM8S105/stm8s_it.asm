...
;	./src/stm8s_it.c: 286: }
	iret
;	./src/stm8s_it.c: 296: INTERRUPT_HANDLER(TIM3_UPD_OVF_BRK_IRQHandler, 15)
;	-----------------------------------------
...
;	./src/stm8s_it.c: 301: }
	iret
;	./src/stm8s_it.c: 308: INTERRUPT_HANDLER(TIM3_CAP_COM_IRQHandler, 16)
;	-----------------------------------------
...
;	./src/stm8s_it.c: 353: }
	iret
;	./src/stm8s_it.c: 361: INTERRUPT_HANDLER(UART2_TX_IRQHandler, 20)
;	-----------------------------------------
...
;	./src/stm8s_it.c: 366: }
	iret
;	./src/stm8s_it.c: 373: INTERRUPT_HANDLER(UART2_RX_IRQHandler, 21)
;	-----------------------------------------
...
;	./src/stm8s_it.c: 462: }
	iret
;	./src/stm8s_it.c: 470: INTERRUPT_HANDLER(EEPROM_EEC_IRQHandler, 24)
;	-----------------------------------------
